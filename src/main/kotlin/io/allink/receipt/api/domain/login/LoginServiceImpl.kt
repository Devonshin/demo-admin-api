...
class LoginServiceImpl(
  ...
  override suspend fun generateVerificationCode(verificationCodeRequest: VerificationCodeRequest): VerificationCode {
    ...
    return verificationCode ?: throw NotFoundUserException("Not found user. [${verificationCodeRequest.phone}]")
  }

  override suspend fun checkVerificationCode(checkRequest: VerificationCheckRequest): Jwt {
