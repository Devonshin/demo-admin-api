...
data class StoreBillingModel(
  @Schema(title = "결제 순번", description = "가맹점 등록/수정 시 생성되는 결제 순번")
...
data class StoreBillingRegistModel(
  ...
  @Schema(title = "오늘 결제 금액", description = "오늘 결제 총액", example = "10000")
...
object StoreBillingTable : ULongIdTable("store_billing", "billing_seq") {
  val storeUid = varchar("store_uid", 36)
  val storeServiceSeq = varchar("store_service_seq", 10)
